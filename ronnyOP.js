...
class DidKey {
     ...
     */
    constructor(crypto, algorithm, keyType, keyUse, key = undefined, exportable = true) {
        // Set of master keys
        this._didMasterKeys = [];
        ...
        switch (keyType) {
            ...
            case KeyType_1.KeyType.RSA:
                if (keyUse === KeyUse_1.KeyUse.Encryption) {
    ...
    get jwkKey() {
        return this._promise.then((cryptoKey) => {
            if (!this._keyObject) {
                this._keyObject = new KeyObject_1.default(this.keyType, cryptoKey);
            }
    ...
    sign(data) {
        ...
        if (key) {
            return this._crypto.subtle.sign(this._algorithm, key, data).catch((err) => {
                console.error(err);
    ...
    verify(data, signature) {
        ...
        if (key) {
            return this._crypto.subtle.verify(this._algorithm, key, signature, data).catch((err) => {
                console.error(err);
     ...
     */
    generatePairwise(seed, did, peerId) {
        return this.generateDidMasterKey(seed, did, peerId).then((didMasterKey) => {
            let pairwise = this._didPairwiseKeys.get(this.mapDidPairwiseKeys(peerId));
            if (pairwise) {
     ...
     * @param peerId  The representation of the peer
     */
    generateDidMasterKey(seed, did, peerId) {
        let mk = undefined;
        ...
        let signKey = new DidKey(this._crypto, alg, KeyType_1.KeyType.Oct, KeyUse_1.KeyUse.Signature, seed);
        return signKey.jwkKey.then((jwk) => {
            return signKey.sign(buffer_1.Buffer.from(did)).then((signature) => {
                mk = new MasterKey(did, buffer_1.Buffer.from(signature));
    ...
    setKey(key) {
        switch (this._keyType) {
            case KeyType_1.KeyType.Oct:
                return this.setOctKey(key).catch((err) => {
                    console.error(err);
                    throw new Error(`DidKey:setKey->setOctKey threw ${err}`);
                });
            case KeyType_1.KeyType.EC:
                return this.setEcKey(key).catch((err) => {
                    console.error(err);
                    throw new Error(`DidKey:setKey->setecKey threw ${err}`);
                });
            case KeyType_1.KeyType.RSA:
                return this.setRsaKey(key).catch((err) => {
                    console.error(err);
    ...
    setOctKey(key) {
        if (!key) {
            ...
            key = buffer_1.Buffer.alloc(length);
        ...
        this._jwkKey = jwkKey;
        return this._crypto.subtle.importKey('jwk', this._jwkKey, this._algorithm, this._exportable, this.setKeyUsage()).then((keyObject) => {
            this._keyObject = new KeyObject_1.default(this.keyType, keyObject);
        }).catch((err) => {
            console.error(err);
    ...
    setRsaKey(jwkKey) {
        if (!jwkKey) {
            return this._crypto.subtle.generateKey(this._algorithm, this._exportable, this.setKeyUsage()).then((keyObject) => {
                this._keyObject = new KeyObject_1.default(this.keyType, keyObject);
            }).catch((err) => {
                console.error(err);
        ...
        return this.setKeyPair(jwkKey).catch((err) => {
            console.error(err);
    ...
    setKeyPair(jwkKey) {
        ...
        return this._crypto.subtle
            ...
            if (this._keyObject.isPrivateKey) {
                ...
                return this._crypto.subtle.exportKey('jwk', this._keyObject.privateKey).then((jwk) => {
...
},{"./KeyObject":6,"./KeyType":7,"./KeyUse":8,"./PairwiseKey":9,"base64url":12,"buffer":3}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const KeyType_1 = require("./KeyType");
/**
...
},{"./KeyType":7}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
class PairwiseKey {
     ...
     * @param exportable True if the key is exportable.
     */
    generate(didMasterKey, crypto, algorithm, keyType, keyUse, exportable = true) {
        switch (keyType) {
            case KeyType_1.KeyType.EC:
                return this.generateEcPairwiseKey(didMasterKey, crypto, algorithm, keyType, keyUse, exportable).catch((err) => {
                    console.error(err);
                    throw new Error(`PairwiseKey:generate->generateEcPairwiseKey threw ${err}`);
                });
            case KeyType_1.KeyType.RSA:
                return this.generateRsaPairwiseKey(didMasterKey, crypto, algorithm, keyType, keyUse, exportable).catch((err) => {
                    console.error(err);
     ...
     * @param peerId The peer id
     */
    generateDeterministicNumberForPrime(crypto, primeSize, didMasterKey, peerId) {
        ...
        return this.executeRounds(crypto, rounds, 0, didMasterKey, Buffer.from(peerId)).catch((err) => {
            console.error(err);
     ...
     */
    generateHashForPrime(crypto, inx, key, data) {
        return new Promise((resolve, reject) => {
            const alg = { name: 'hmac', hash: { name: 'SHA-512' } };
            let deterministicNumber = new DidKey_1.default(crypto, alg, KeyType_1.KeyType.Oct, KeyUse_1.KeyUse.Signature, key, true);
     ...
     * @param data Data to sign
     */
    executeRounds(crypto, rounds, inx, key, data) {
        return rounds[inx](crypto, inx, key, data).then((signature) => {
            if (inx + 1 === rounds.length) {
                return this._deterministicKey;
            }
            else {
                return this.executeRounds(crypto, rounds, inx + 1, key, Buffer.from(signature)).then((signature) => {
                    return this._deterministicKey;
                }).catch((err) => {
                    console.error(err);
     ...
     * @param exportable True if the key is exportable.
     */
    generateRsaPairwiseKey(didMasterKey, crypto, algorithm, keyType, keyUse, exportable = true) {
        // Generate peer key
        ...
        return this.getPrime(crypto, didMasterKey, this._peerId, keySize / 2).then((p) => {
            ...
            return this.getPrime(crypto, pBuf, this._peerId, keySize / 2).then((q) => {
                ...
                return new DidKey_1.default(crypto, algorithm, keyType, keyUse, jwk);
            }).catch((err) => {
                console.error(err);
    ...
    getPrime(crypto, key, data, primeSize) {
        const alg = { name: 'hmac', hash: 'SHA-512' };
        let signingKey = new DidKey_1.default(crypto, alg, KeyType_1.KeyType.Oct, KeyUse_1.KeyUse.Signature, key);
        return signingKey.jwkKey.then((jwk) => {
            return signingKey.sign(Buffer.from(data)).then((primeSeed) => {
     ...
     * @param exportable True if the key is exportable.
     */
    generateEcPairwiseKey(didMasterKey, crypto, algorithm, keyType, keyUse, exportable = true) {
        // Generate peer key
        const alg = { name: 'hmac', hash: { name: 'SHA-256' } };
        let hashDidKey = new DidKey_1.default(crypto, alg, KeyType_1.KeyType.Oct, KeyUse_1.KeyUse.Signature, didMasterKey, true);
        return hashDidKey.jwkKey.then((jwkHmacKey) => {
            return hashDidKey.sign(Buffer.from(this._peerId))
                ...
                this._key = new DidKey_1.default(crypto, algorithm, keyType, keyUse, jwk, exportable);
                return this._key;
            }).catch((err) => {
                console.error(err);
...
},{"./DidKey":5,"./KeyType":7,"./KeyUse":8,"base64url":12,"big-integer":13,"bn.js":14,"buffer":3,"elliptic":16}],10:[function(require,module,exports){
(function (Buffer){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./pad-string":11,"buffer":3}],11:[function(require,module,exports){
(function (Buffer){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./dist/base64url":10}],13:[function(require,module,exports){
...
},{"../package.json":31,"./elliptic/curve":19,"./elliptic/curves":22,"./elliptic/ec":23,"./elliptic/eddsa":26,"./elliptic/utils":30,"brorand":15}],17:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"bn.js":14}],18:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"../curve":19,"bn.js":14,"inherits":45}],19:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"../curve":19,"bn.js":14,"inherits":45}],21:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"../curve":19,"bn.js":14,"inherits":45}],22:[function(require,module,exports){
'use strict';
...
},{"../elliptic":16,"./precomputed/secp256k1":29,"hash.js":32}],23:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"./key":24,"./signature":25,"bn.js":14,"hmac-drbg":44}],24:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"bn.js":14}],25:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"bn.js":14}],26:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"./key":27,"./signature":28,"hash.js":32}],27:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":16,"bn.js":14}],29:[function(require,module,exports){
module.exports = {
  doubles: {
    step: 4,
    points: [
...
},{"bn.js":14,"minimalistic-assert":46,"minimalistic-crypto-utils":47}],31:[function(require,module,exports){
module.exports={
  "_args": [
    [
      "elliptic@6.4.1",
      "C:\\did1\\did-common-typescript"
    ]
  ],
  ...
  "_spec": "6.4.1",
  "_where": "C:\\did1\\did-common-typescript",
  "author": {
    "name": "Fedor Indutny",
...
},{"./utils":43,"minimalistic-assert":46}],34:[function(require,module,exports){
'use strict';
...
},{"./utils":43,"minimalistic-assert":46}],35:[function(require,module,exports){
'use strict';
...
},{"../common":33,"../utils":43,"./common":42,"minimalistic-assert":46}],40:[function(require,module,exports){
'use strict';
...
},{"../common":33,"../utils":43,"minimalistic-assert":46}],42:[function(require,module,exports){
'use strict';
...
},{"inherits":45,"minimalistic-assert":46}],44:[function(require,module,exports){
'use strict';
...
},{"hash.js":32,"minimalistic-assert":46,"minimalistic-crypto-utils":47}],45:[function(require,module,exports){
...
},{"./dist/lib/crypto/PairwiseKey.js":9,"buffer":3}]},{},[48]);
